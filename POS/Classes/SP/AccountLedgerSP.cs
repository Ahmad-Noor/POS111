    ...
    class AccountLedgerSP : DBConnection
    {
        ...
        public void AccountLedgerAdd(AccountLedgerInfo accountledgerinfo)
        {
            try
            {
                ...
                sprmparam = sccmd.Parameters.Add("@Branch_ID", SqlDbType.VarChar);
                sprmparam.Value = accountledgerinfo.Branch_ID;
        ...
        public AccountLedgerInfo AccountLedgerView(decimal ledgerId)
        {
            ...
            try
            {
                ...
                while (sdrreader.Read())
                {
                    ...
                    accountledgerinfo.Branch_ID = sdrreader["Branch_ID"].ToString();
        ...
        public AccountLedgerInfo AccountLedgerViewForEdit(decimal ledgerId)
        {
            ...
            try
            {
                ...
                while (sdrreader.Read())
                {
                    ...
                    accountledgerinfo.Branch_ID = sdrreader[21].ToString();
        ...
        public AccountLedgerInfo AccountLedgerViewForCustomer(decimal ledgerId)
        {
            ...
            try
            {
                ...
                while (sdrreader.Read())
                {
                    ...
                    accountledgerinfo.Branch_ID = sdrreader[20].ToString();
        ...
        public AccountLedgerInfo AccountLedgerViewForSupplier(decimal ledgerId)
        {
            ...
            try
            {
                ...
                while (sdrreader.Read())
                {
                    ...
                    accountledgerinfo.Branch_ID = sdrreader[17].ToString();
