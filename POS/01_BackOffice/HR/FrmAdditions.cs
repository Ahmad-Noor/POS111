...
namespace POS
{
    public partial class FrmAdditions : SkyForm
    {
        public FrmAdditions()
        {
            InitializeComponent();
        ...
        private MATRIX mTable = new MATRIX("Additions");
        ...
        public void btnNew_Click(System.Object sender, System.EventArgs e)
        {
            ...
            cmbAdditionsType.SelectedIndex = 0;
        ...
        public void btnSave_Click(System.Object sender, System.EventArgs e)
        {
            ...
            if (cmbAdditionsType.SelectedIndex == 0)
            {
            ...
            try
            {
                ...
                if (NewRecord)
                {
                    ...
                    Settings.ExecuteReader("select OrderNo from Additions where " + s);
                ...
                mTable["AdditionsCode"] = cmbAdditionsType.SelectedValue;
        ...
        public void Retrieve()
        {
            ...
            cmbAdditionsType.SelectedValue = mTable["AdditionsCode"];
        ...
        public void btnSearchByName_Click(System.Object sender, System.EventArgs e)
        {
            ...
            var s1 = "SELECT OrderNo رقم, OrderDate التاريخ,Amount المبلغ FROM dbo.Additions where Year=" + Settings.CurrentYear;
        ...
        private void FrmAdditions_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            Settings.CreateMaster("AdditionsTypes", "الاضافات والمكافأت");
            FillAdditionsType();
        }
