...
using POS.CrystalReports.Reports;
using POS.CrystalReports.Reports.ProductStatisticsReports;
using CrystalDecisions.CrystalReports.Engine;
using crptStockReport = POS.CrystalReports.Reports.crptStockReport;
